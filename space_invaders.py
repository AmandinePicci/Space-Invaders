...
#-------------------------------------------------------------------------------------------------------------------------------
buttonStart = Button(fenetre, text="Nouvelle Partie", fg='red') #command=)    #Bouton start permettant de commencer une nouvelle partie
...
blocProtection=Protections(can1)
