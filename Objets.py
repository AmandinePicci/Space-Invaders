...
class Alien: 
    ...
    def __init__(self, general, id, niv, root):         
    ...
    def tire(self):
        ...
        if self.exist ==True :
            P.ProjectileAlien(self.general, self.canne.coords(self.rectangle)[0],  self.canne.coords(self.rectangle)[1], self.root)     #création du projectile et lancement en appelant la classe ProjectileAlien du fichier Projectiles
